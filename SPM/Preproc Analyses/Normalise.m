...
for subject=subjects
    ...
    if isfile(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-3_space-T1w_desc-preproc_bold_denoised.nii']) == 0
        display('Run 3 has not been unzipped; unzipping now')
        gunzip(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-3_space-T1w_desc-preproc_bold_denoised.nii.gz'])
    else
        display('Run 3 is already unzipped; doing nothing')
    end

    if isfile(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-4_space-T1w_desc-preproc_bold_denoised.nii']) == 0
        display('Run 4 has not been unzipped; unzipping now')
        gunzip(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-4_space-T1w_desc-preproc_bold_denoised.nii.gz'])
    else
        display('Run 4 is already unzipped; doing nothing')
    end

    if isfile(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-5_space-T1w_desc-preproc_bold_denoised.nii']) == 0
        display('Run 5 has not been unzipped; unzipping now')
        gunzip(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-5_space-T1w_desc-preproc_bold_denoised.nii.gz'])
    else
        display('Run 5 is already unzipped; doing nothing')
    end

    if isfile(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-6_space-T1w_desc-preproc_bold_denoised.nii']) == 0
        display('Run 6 has not been unzipped; unzipping now')
        gunzip(['D:\Riet\CaseStudies\Analyses\Data\fmriprep\sub-' subject '\sub-' subject '_ses-1_task-motor_run-6_space-T1w_desc-preproc_bold_denoised.nii.gz'])
    else
        display('Run 6 is already unzipped; doing nothing')
    end

%% Normalise
matlabbatch{1}.spm.spatial.normalise.write.subj.def = {['D:\Riet\CaseStudies\Analyses\Data\anat\sub-' subject '\ses-1\anat\y_rsub-' subject '_ses-1_run-01_T1w.nii']};
%%
